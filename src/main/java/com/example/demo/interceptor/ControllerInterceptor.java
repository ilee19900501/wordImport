...
public class ControllerInterceptor {    
     ...
     */
    static final String pCutStr = "execution(* com.example.*..login(..))";
        ...
        try {
            ...
            for (Object arg : args) {
                if(arg instanceof UserInfo) {
                    ...
                    log.info("参数userId:{},参数userName:{}",userInfo.getUserId(),
    ...
    @Before(value = "execution(* com.example.demo.controller.*.login(..))")
    ...
    @AfterReturning(value = "execution(* com.example.demo.controller.*.login(..))")
